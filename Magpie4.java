...
public class Magpie4
{
	 ...
	 * the user statement
	 * @return 
	 * the transformed statement in “Would you really be happy if you had something?” form.
	 */
	private String transformIWantStatement(String statement) {
		// TODO Auto-generated method stub
		statement = statement.trim();
		String rt = statement.substring(7 , statement.length());
		return "Would you really be happy if you had " + rt + "?";
	 ...
	 * @return the transformed statement in "Why do you <something> me?" form.
	 */
	private String transformIYouStatement(String statement){
		statement = statement.trim();
		int psnOfI = findKeyword(statement, "I" , 0);
		int psnOfyou = findKeyword(statement, "you" , psnOfI+1);
		String between = statement.substring(psnOfI+2, psnOfyou-1);
