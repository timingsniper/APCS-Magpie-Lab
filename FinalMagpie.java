...
public class FinalMagpie
{
	...
	private String [] randomResponses = {"Interesting, tell me more",
			...
			"You don't say.", //Additional four random responses are added
			"Let it go.",
			"Yeah. Whatever.",
			"Say that again?",
			"Go learn java.",
	 ...
	 * Test Result:
	 * 
	 * Input 1: hi, Answer: Interesting, tell me more
	 * Input 2: fridge, Answer: Say that again?
	 * Input 3: dj, Answer: Go learn java.
	 * Input 4: a, Answer: Yeah, Whatever.
	 * Input 5: a, Answer: Yeah, Whatever.
	 * Input 6: a, Answer: Let it go.
	 * Input 7: a, Answer: This is life.
	 * Input 8: a, Ansser: Percy is so awesome
	 * All four new added repsonses(also the responses that were added in activity 2) were shown.
	 */
